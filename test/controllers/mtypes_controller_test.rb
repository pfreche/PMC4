...
class MtypesControllerTest < ActionController::TestCase
  ...
  test "should create mtype" do
    assert_difference('Mtype.count') do
      post :create, mtype: { has_file: @mtype.has_file, icon: @mtype.icon, model: @mtype.model, name: @mtype.name }
    end
  ...
  test "should update mtype" do
    patch :update, id: @mtype, mtype: { has_file: @mtype.has_file, icon: @mtype.icon, model: @mtype.model, name: @mtype.name }
    assert_redirected_to mtype_path(assigns(:mtype))
  end
