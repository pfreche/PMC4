...
class FoldersControllerTest < ActionController::TestCase
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post :create, folder: { lfolder: @folder.lfolder, mfile_id: @folder.mfile_id, mpath: @folder.mpath, storage_id: @folder.storage_id }
    end
  ...
  test "should update folder" do
    patch :update, id: @folder, folder: { lfolder: @folder.lfolder, mfile_id: @folder.mfile_id, mpath: @folder.mpath, storage_id: @folder.storage_id }
    assert_redirected_to folder_path(assigns(:folder))
  end
